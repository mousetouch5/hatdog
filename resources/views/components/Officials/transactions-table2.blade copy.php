...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchTransactions(query = '', page = 1) {
            $.ajax({
                url: '{{ route('api.transactions2') }}', // Your route for transactions
                method: 'GET',
                data: {
                ...
                success: function(data) {
                    ...
                    data.data.forEach(function(trs) { // Notice the use of data.data
                    ...
                    $('.prev-page').click(function() {
                        fetchTransactions(query, data.prev_page_url.split('=')[
                            1]); // Get page number from URL
                    });
                    $('.next-page').click(function() {
                        fetchTransactions(query, data.next_page_url.split('=')[
                            1]); // Get page number from URL
                    });
                },
